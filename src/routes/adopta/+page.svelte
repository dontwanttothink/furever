...
{#if userData}
	...
	<form>
		...
		<label>
			<br />
			*En caso de ser arrendador, ¿El dueño del inmueble tiene conocimiento de la
			posible adopción y dio autorización para llevarla a cabo?
		</label><br />
		<label>
		...
		<br />
		<label>
			¿Alguna de las personas dentro del hogar sufre de ataques de ira o alguna
			enfermedad que desencadene algún tipo de violencia?
		...
		<br />
		<label>
			¿Alguna de las personas dentro del hogar padece de enfermedades alérgicas
			o patologías a las cuales el médico tratante les ha recomendado no tener
			mascotas?
			<select name="alergia">
				<option value="Sí">Sí</option>
				<option value="No">No</option>
